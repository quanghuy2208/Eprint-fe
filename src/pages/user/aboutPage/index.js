            ...
            <div className="grid banner">
                ...
                <div className="banner__title">
                    ...
                    <div className="banner__dscr">
                        <span>Home</span> <div className="banner__space"></div> Về Eprint
                    </div>
                </div>
            </div>
                ...
                <div className="grid wide about-content">
                    <div className="row">
                        ...
                        <div className="col l-6">
                            ...
                            <h2>
                                EPrint là đơn vị hàng đầu tại VN, chuyên cung cấp dịch vụ in ấn và thiết kế đa ngành
                                nghề
                            </h2>
                            <div className="about-dscr">
                                <span>
                                    Với hơn 7 năm kinh nghiệm, chúng tôi đã đồng hành cùng 1000+ doanh nghiệp và thực
                                    hiện hơn 3000 dự án về thiết kế và in ấn.
                                </span>
                            </div>
                            <div className="row">
                                <div className="">
                            ...
                            <div className="about-info">
                                Các gói dịch vụ in phong phú tại EPrint với giá thành minh bạch giúp khách hàng tối ưu
                                chi phí và đáp ứng nhu cầu in đa dạng của khách hàng. Đội ngũ nhân viên của EPrint luôn
                                nỗ lực, tích cực nâng cao kỹ năng, kinh nghiệm để mang đến cho khách hàng những trải
                                nghiệm sản phẩm, dịch vụ chất lượng nhất.
                            </div>
                ...
                <div className="grid wide vision">
                    ...
                    <div className="row">
                        <div className="col l-4 vision-align">
                            EPrint định hướng trở thành đơn vị chuyên nghiệp hàng đầu và là nguồn cảm hứng sáng tạo
                            trong lĩnh vực in ấn và thiết kế tại Việt Nam
                        </div>
                        <div className="col l-4 vision-align">
                        ...
                        <div className="col l-4 vision-align">
                            Mang đến những giá trị cho khách hàng thông qua giải pháp Thiết kế sáng tạo - In tiêu chuẩn
                            - Giá cả cạnh tranh
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="col l-4 value-align">
                            <div className="value-item">
                                ...
                                <div className="value__dscr">
                                    Thiết kế độc quyền, mang tính thẩm mỹ cao và chuẩn nhận diện thương hiệu
                                </div>
                            </div>
                            <div className="value-item">
                                ...
                                <div className="value__dscr">
                                    Ứng dụng và triển khai nhanh, tiến độ in và giao hàng đúng hẹn
                                </div>
                            </div>
                        </div>
                        <div className="col l-4 value-align">
                            <div className="value-item">
                                ...
                                <div className="value__dscr">
                                    Cam kết cung cấp sản phẩm và dịch vụ với chất lượng tốt nhất, đảm bảo sự hài lòng và
                            ...
                            <div className="value-item">
                                ...
                                <div className="value__dscr">
                                    Linh hoạt trong việc đáp ứng nhu cầu đa dạng của khách hàng và tối ưu hóa quy trình
                                    làm việc để đáp ứng các yêu cầu đặc biệt
                                </div>
                            </div>
                        </div>
                        <div className="col l-4 value-align">
                            <div className="value-item">
                                ...
                                <div className="value__dscr">
                                    Đảm bảo tuân thủ các tiêu chuẩn đạo đức và môi trường, đồng thời chăm sóc tốt nhất
                                    cho khách hàng, nhân viên và cộng đồng
                                </div>
                            </div>
                            <div className="value-item">
                                ...
                                <div className="value__dscr">
                                    Không ngừng cải tiến và cập nhật các công nghệ mới nhất để tạo nên những thành phẩm
                                    chất lượng cao
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="contact-align">
                                ...
                                <div className="contact-content">
                                    ...
                                    <div className="contact-dscr">
                                        Cam kết về sự chuyên nghiệp và đảm bảo về chất lượng sản phẩm cho thương hiệu
                                        của doanh nghiệp
                                    </div>
                                </div>
                                <div className="contact-content">
                                    ...
                                    <div className="contact-dscr">
                                        Tối ưu chi phí, nguồn lực và tài nguyên cho doanh nghiệp
                                    </div>
                                </div>
                            </div>
                        </div>
