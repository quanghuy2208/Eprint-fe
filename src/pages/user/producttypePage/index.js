                    ...
                    <div className="row unique-method-background">
                        ...
                        <div className="col l-8">
                            <div className="unique-method-dscr">
                                Quy cách in ấn lịch Tết thường sẽ có nhiều bước khác nhau, phụ thuộc vào từng yêu cầu
                                khác nhau của mỗi khách hàng. Tuy nhiên nhìn chung đều có những quy trình về:
                            </div>
                            <div className="scroll-container">
                                <div className="unique-method-dscr-title">Chất liệu giấy in lịch Tết:</div>
                                <div className="unique-method-dscr">
                                    Hiện nay có rất nhiều loại giấy khác nhau được ứng dụng làm giấy lịch, mỗi loại đều
                                        ...
                                        <div className="modal-content">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    chất liệu giấy Couches Matt, phần đế lịch được sản xuất vàng chất
                                                    liệu: ván MDF hoặc carton lạnh
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <span>Lịch để bàn: </span>Tờ lịch thường sẽ in trên Couches, định
                                                    lượng 250 gsm
                                                </li>
                                                <li>
                                                    <span>Lịch gỗ: </span>Giống với tên gọi, sản phẩm được triển khai
                                                    trên chất liệu gỗ nhữ gỗ thông, gỗ ép, ... kết hợp với gia công khắc
                                                    lazer; in phun, ... tạo nên thành phẩm
                                                </li>
                                            </ul>
                                            <div className="modal-dscr">
                                                Ngoài ra, sẽ có rất nhiều loại lịch làm với quy cách đặc biệt, chất liệu
                                                khác nhau, khách hàng có nhu cầu hãy để lại liên hệ để tư vấn chi tiết
                                                hơn.
                                            </div>
                                        </div>
                                    </div>
